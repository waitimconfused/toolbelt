...
export class CustomMenu extends HTMLElement {
	...
	#toolbar() {
		...
		function snap() {
			...
			self.style.transition = `top 300ms ${CustomMenu.toolbarSnapEasing}, left 300ms ${CustomMenu.toolbarSnapEasing}`;
	 ...
	 */
	static toolbarSnapEasing = "linear(0, 0.009 1%, 0.035 2%, 0.137 4.2%, 0.273 6.3%, 0.708 12.3%, 0.827 14.2%, 0.923 16%, 1.002 17.8%, 1.065 19.7%, 1.11 21.6%, 1.137 23.5%, 1.15 26%, 1.143 28.9%, 1.017 41.7%, 0.993 45.5%, 0.98 49.5%, 0.979 55.3%, 1.003 74.7%, 1)";
}
